...
const WindowView = (props: { window: Optional<WindowSpace> }) => {
	...
	return (
		<div className="flex-1 border-gray border-solid border-2 rounded-xl flex justify-center items-center relative">
			<div className="absolute text-gray max-w-full break-words text-align-center">
				{text}
			</div>
		</div>
	);
